                ...
                <section class="adding-post__photo tabs__content tabs__content--active">
                    ...
                    <form class="adding-post__form form" action="#" method="post" enctype="multipart/form-data">
                        <div class="form__text-inputs-wrapper">
                            ...
                            <div class="adding-post__input-wrapper form__input-wrapper" hidden>
                                <label class="adding-post__label form__label" for="form-type">Тип формы</label>
                                <div class="form__input-section">
                                    <input class="adding-post__input form__input" id="form-type" type="text" name="content-type" value="photo">
                                </div>
                            </div>

                            <?php if ($content_type === 'photo' && empty($errors) === false) : ?>
                    ...
                    <form class="adding-post__form form" action="#" method="post" enctype="multipart/form-data">
                        <div class="form__text-inputs-wrapper">
                            ...
                            <div class="adding-post__input-wrapper form__input-wrapper" hidden>
                                <label class="adding-post__label form__label" for="form-type">Тип формы</label>
                                <div class="form__input-section">
                                    <input class="adding-post__input form__input" id="form-type" type="text" name="content-type" value="video">
                                </div>
                            </div>

                            <?php if ($content_type === 'video' && empty($errors) === false) : ?>
                                <div class="form__invalid-block">
                                    <b class="form__invalid-slogan">Пожалуйста, исправьте следующие ошибки:</b>
                    ...
                    <form class="adding-post__form form" action="#" method="post">
                        <div class="form__text-inputs-wrapper">
                            ...
                            <div class="adding-post__input-wrapper form__input-wrapper" hidden>
                                <label class="adding-post__label form__label" for="form-type">Тип формы</label>
                                <div class="form__input-section">
                                    <input class="adding-post__input form__input" id="form-type" type="text" name="content-type" value="text">
                                </div>
                            </div>

                            <?php if ($content_type === 'text' && empty($errors) === false) : ?>
                                <div class="form__invalid-block">
                                    <b class="form__invalid-slogan">Пожалуйста, исправьте следующие ошибки:</b>
                                    <?php foreach ($errors as $error) : ?>
                                        <ul class="form__invalid-list">
                    ...
                    <form class="adding-post__form form" action="#" method="post">
                        <div class="form__text-inputs-wrapper">
                            ...
                            <div class="adding-post__input-wrapper form__input-wrapper" hidden>
                                <label class="adding-post__label form__label" for="form-type">Тип формы</label>
                                <div class="form__input-section">
                                    <input class="adding-post__input form__input" id="form-type" type="text" name="content-type" value="quote">
                                </div>
                            </div>

                            <?php if ($content_type === 'quote' && empty($errors) === false) : ?>
                                <div class="form__invalid-block">
                                    <b class="form__invalid-slogan">Пожалуйста, исправьте следующие ошибки:</b>
                                    <?php foreach ($errors as $error) : ?>
                                        <ul class="form__invalid-list">
                    ...
                    <form class="adding-post__form form" action="#" method="post">
                        <div class="form__text-inputs-wrapper">
                            ...
                            <div class="adding-post__input-wrapper form__input-wrapper" hidden>
                                <label class="adding-post__label form__label" for="form-type">Тип формы</label>
                                <div class="form__input-section">
                                    <input class="adding-post__input form__input" id="form-type" type="text" name="content-type" value="link">
                                </div>
                            </div>

                            <?php if ($content_type === 'link' && empty($errors) === false) : ?>
                                <div class="form__invalid-block">
                                    <b class="form__invalid-slogan">Пожалуйста, исправьте следующие ошибки:</b>
                                    <?php foreach ($errors as $error) : ?>
                                        <ul class="form__invalid-list">
